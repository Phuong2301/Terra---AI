...
class AssessmentLocalStore {
  ...
  static const remoteHistoryKey = 'assessments_remote_history_v1';

  static Future<void> saveDraft(Map<String, dynamic> json) async {
    final prefs = await SharedPreferences.getInstance();
    await prefs.setString(draftKey, jsonEncode(json));
  }
  static Future<void> saveRemoteHistory(List<Map<String, dynamic>> list) async {
    final prefs = await SharedPreferences.getInstance();
    await prefs.setString(remoteHistoryKey, jsonEncode(list));
  }

  static Future<List<Map<String, dynamic>>> loadRemoteHistory() async {
    final prefs = await SharedPreferences.getInstance();
    final raw = prefs.getString(remoteHistoryKey);
